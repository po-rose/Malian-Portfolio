    ...
    return (
        <div style={(props.visible || props.isShutDown ? { zIndex: "100" } : { zIndex: "-20" })} className={(props.visible || props.isShutDown ? " visible opacity-100" : " invisible opacity-0 ") + " absolute duration-500 select-none flex flex-col justify-around items-center top-0 right-0 overflow-hidden m-0 p-0 h-screen w-screen bg-black"}>
            ...
            <div className="text-white mb-4 flex">
                <a href="https://www.linkedin.com/in/malian-yang-a4458b272/" rel="noreferrer noopener" target="_blank">
                    <img width="40px" src="https://img.icons8.com/fluency/344/linkedin.png" />
                </a>
                <span className="font-bold mx-1 mt-2">|</span>
                <a href="https://github.com/po-rose/" rel="noreferrer noopener" target="_blank">
