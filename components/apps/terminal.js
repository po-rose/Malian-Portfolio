...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            projects: ["malian-personal-portfolio", "synonyms-list-react", "economist.com-unlocked", "Improve-Codeforces", "flutter-banking-app", "Meditech-Healthcare", "CPU-Scheduling-APP-React-Native"],
            interests: ["Chatbot Engineering", "Deep Learning", "Computer Vision"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className="text-ubt-green">malian@ASUS</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/malian")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemenharuka.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-malian, about-resume, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "about-malian":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-malian");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemenharuka.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-malian, about-resume, todoist, trash, settings, sendmsg ]";
                }
                break;
            ...
            case "sudo":
                ...
                result = "<img class='w-1/3' src='./images/memes/used-sudo-command.jpg' />";
                break;
            default:
                result = "Command '" + main + "' not found, or not yet implemenharuka.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-malian, about-resume, todoist, trash, settings, sendmsg ]";
        }
